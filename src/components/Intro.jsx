  ...
  return (
    <>
      ...
      <p className="mt-4 text-gray-300 text-sm/6">
        Esse é o changelog do Codante.io. Aqui vamos postar as novidades da Codante.io - de código ou de conteúdo. Queremos manter o compromisso de transparência com uma comunidade aberta. 
      </p>
      <SignUpForm />
      <div className="flex flex-wrap justify-center mt-8 gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
        <IconLink href="https://codante.io" icon={BookIcon} className="flex-none">
          Codante.io
        </IconLink>
        <IconLink href="https://github.com/codante-io" icon={GitHubIcon} className="flex-none">
          GitHub
        </IconLink>
